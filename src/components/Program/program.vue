      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
          ...
          <p class="text-lg md:text-[16px] text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            full potential through four integrated programs: Education, Training, Care, and Giving Back. Together, these
            components form a holistic approach to breaking the cycle of poverty, building a more equitable future, and
            ensuring that no girl is denied the opportunity to learn because of economic or social barriers.
          </p>
        </div>
        <!-- Education Program -->
        <div v-for="(program, index) in programs.filter(p => p.section === 'Education')" :key="`education-${index}`"
          class="mt-24">
            ...
            <div class="p-8 md:p-10 lg:p-16">
              ...
              <router-link :to="{ name: 'education' }"
                ...
                <span class="relative z-10 flex items-center">
                  ...
                  <svg class="w-4 h-4 md:w-5 md:h-5 ml-2 group-hover:translate-x-1 transition-transform duration-300"
                ...
                <div
                  class="absolute inset-0 -top-2 -bottom-2 bg-gradient-to-r from-transparent via-white/20 to-transparent skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-700">
                </div>
              </router-link>
            </div>
            <!-- Sub-sections -->
