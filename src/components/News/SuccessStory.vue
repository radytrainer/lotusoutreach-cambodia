<template>
  <section class="py-16 bg-white font-poppins">
    <div class="text-center mb-24">
      <h1
        class="text-3xl md:text-3xl font-extrabold text-gray-900 mb-4 tracking-tight"
      >
    ...
    <div class="container mx-auto px-4 max-w-7xl">
      ...
      >
        ...
        <div
          class="relative w-full lg:w-1/2 flex justify-center items-center p-4"
        >
          ...
          <Transition name="fade" mode="out-in">
            <div
              :key="currentStoryIndex"
              class="absolute bottom-24 left-1/2 -translate-x-1/2 w-[calc(100%+60px)] z-10"
            >
              <div class="relative flex flex-col items-center">
                ...
                <!-- Program -->
                <div
                  class="absolute top-12 left-52 bg-blue-500 text-white px-4 py-2 transform -skew-y-6 -rotate-6 shadow-lg text-center w-full max-w-[250px] md:max-w-[350px] z-10"
                >
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center lg:pl-12">
          <Transition name="fade" mode="out-in">
            <div :key="currentStoryIndex" class="mb-6 mt-8">
              <span
                class="text-blue-400 text-6xl font-extrabold leading-none block mb-4"
                >“</span
              >
              ...
              <router-link
                :to="{ name: 'StoryDetail', params: { id: currentStoryIndex } }"
...
const currentStory = computed(
  () => props.stories[currentStoryIndex.value] || {}
);
