<template>
  <section class="py-8 md:py-16 bg-white font-poppins">
    <div class="container mx-auto px-4 max-w-7xl">
      <!-- Updated Back Button to navigate to NewsStory -->
      ...
      <div class="relative mb-8 md:mb-12 rounded-lg overflow-hidden shadow-lg">
        <img :src="currentStory.avatar" :alt="currentStory.name + ' graduating'"
          class="w-full h-64 md:h-96 object-cover object-button" />
        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent p-6 flex flex-col justify-end">
          <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-2">{{ currentStory.name }}</h1>
      ...
      <div class="mb-8 md:mb-12">
        ...
        <div class="space-y-8">
          <div v-for="(item, index) in currentStory.fullStory" :key="index" class="bg-white p-6 rounded-lg shadow-sm">
            <h3 v-if="item.title" class="text-xl md:text-2xl font-semibold text-gray-800 mb-3">{{ item.title }}</h3>
    ...
    fullStory: [
      {
        ...
        content: 'Sat Marany, a 22-year-old from Banteay Meanchey Province, has shown remarkable resilience and determination throughout her academic journey. Since Grade 7, her parents have worked in Thailand, leaving her and her brother in the care of their grandparents.',
      },
      {
        title: 'Academic Achievements and Scholarship',
        content: 'Marany became a recipient of the CATALYST Scholarship from Lotus Outreach Cambodia during her first year at university and remained in the program until graduation. In 2024, she graduated with distinction from the Royal University of Phnom Penh, earning a degree in Physics with a perfect GPA of 4.00 in her final year.',
      },
      {
        title: 'Current Employment and Volunteering',
        content: 'Today, Marany works part-time at ISF International School and also offers private tutoring, earning approximately $600 per month. Despite her full schedule, she continues to volunteer at the Optoelectronics & Advanced Materials Laboratory at her university, demonstrating her passion for lifelong learning.',
      },
      {
        title: 'International Workshop Participation',
        content: 'Her academic interests led her to participate in the Asian Network School and Workshop on Complex Condensed Matter Systems 2024, held in Thailand from November 10–16, where she broadened her scientific knowledge and professional network.',
      },
      {
        title: 'Commitment to Education and Community',
        content: 'Marany is deeply committed to education and community service. She regularly volunteers in activities that link science with social impact and serves as a mentor to younger students, sharing her life experiences to inspire and guide them. She is also deeply involved in her younger brother’s education, providing both financial and academic support. In addition, she contributes to her parents’ and grandparents’ living expenses.',
      },
      {
        title: 'Future Aspirations',
        content: 'Marany’s long-term goal is to reunite her family in Cambodia. Motivated by this dream, she continues to focus on her personal development and is actively seeking scholarship opportunities to pursue a master’s degree in physics or a related science field abroad.',
      },
      {
        title: 'Gratitude and Acknowledgments',
        content: 'She extends her heartfelt gratitude to the donors who have made it possible for underprivileged Cambodian girls to access higher education and transform their lives. She also gives special thanks to the dedicated staff of Lotus Outreach Cambodia, especially Ms. Raksmey and Ms. Pisey, for their unwavering support and guidance—both academically and personally. Their encouragement and belief in the students\' potential have empowered Marany and many others to persevere and thrive, despite life\'s many challenges.',
      },
    ],
  },
  {
    ...
    fullStory: [
      {
        ...
        "content": "My name is Sall Kannika, and I am a first-year Computer Science student at Asia Euro University. I recently had the incredible opportunity to participate in the Design Thinking Hackathon, a youth program funded by Hub Phnom Penh. Out of many applicants, I was proud to be selected as one of 20 finalists from Phnom Penh and Battambang."
      },
      {
        "title": "Program Overview and Goals",
        "content": "The program lasted five days, including three days of intensive training and two days of travel between Phnom Penh and Battambang. Everything—from transportation and meals to accommodation—was fully sponsored for participants traveling from Phnom Penh. The Design Thinking Hackathon aimed to equip young people with essential life skills, leadership abilities, and real-world problem-solving experience."
      },
      {
        "title": "Day 1: Self-Discovery",
        "content": "Day 1 focused on self-discovery. We used tools like mind mapping to explore the differences between a growth mindset and a fixed mindset. We also engaged in deep self-reflection, learning to identify our personal values, strengths, and weaknesses."
      },
      {
        "title": "Day 2: Community Problem-Solving",
        "content": "Day 2 centered on community problem-solving. We explored local issues, formed teams, identified root causes, and applied Design Thinking techniques to craft innovative solutions."
      },
      {
        "title": "Day 3: Building and Presenting Solutions",
        "content": "Day 3 was dedicated to building and presenting our solutions. Each team pitched their ideas, and the top four teams, including mine, received seed funding and mentoring support to bring their projects to life. My team’s project, A+ Forum, was well-received, winning $500 in seed funding and a certificate of achievement."
      },
      {
        "title": "Project Implementation",
        "content": "The winning four teams, each with four members, are currently implementing their projects over a two-month period with mentor support, gaining real-life experience in project planning, teamwork, and social impact. Even teams that did not win were encouraged to pursue their ideas, reinforcing that every effort counts toward community change."
      },
      {
        "title": "Life-Changing Experience and Skill Development",
        "content": "Participating in this program was a life-changing experience. I built meaningful friendships and networks with 40 inspiring youths and mentors from Battambang and Phnom Penh, applied Design Thinking to tackle real community problems, and strengthened my leadership, teamwork, and problem-solving skills."
      },
      {
        "title": "Personal Growth and Reaffirmation",
        "content": "I developed greater self-awareness by exploring my values, strengths, weaknesses, and aspirations, and gained a deeper understanding of local challenges through community-based learning. This journey has reaffirmed my passion for learning, community development, and innovation."
      },
      {
        "title": "My Project: A+ Forum",
        "content": "I presented my project, A+ Forum, during the final pitch competition. The idea was well-received, and our team was selected as one of the winners. We are now in the process of turning this vision into reality with the support of our mentors and the $500 implementation grant."
      }
    ]
  },
  {
