  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 p-6">
    <div class="max-w-7xl mx-auto">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="space-y-6">
              ...
              <div class="space-y-4">
                ...
                <div class="group">
                  <label class="block text-sm font-semibold text-gray-700 mb-2">Or Upload Main Image</label>
                  <div class="relative">
                    <input 
                      type="file" 
                      accept="image/*" 
                  ...
                  <div v-if="mainImagePreview" class="mt-4 flex justify-center">
                    <div class="relative group">
                      <img :src="mainImagePreview" alt="Main image preview" class="h-32 w-32 object-cover rounded-xl shadow-lg border-4 border-white" />
                      <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 transition-all duration-200 rounded-xl"></div>
                    </div>
                  </div>
              ...
              <div class="space-y-4">
                ...
                <div class="group">
                  <label class="block text-sm font-semibold text-gray-700 mb-2">Or Upload Additional Images</label>
                  <input 
                    type="file" 
                    accept="image/*" 
                    multiple 
                  ...
                  <div v-if="additionalImagesPreview.length" class="mt-4 grid grid-cols-4 gap-3">
                    <div v-for="(preview, index) in additionalImagesPreview" :key="index" class="relative group">
                      <img :src="preview" alt="Additional image preview" class="h-20 w-20 object-cover rounded-lg shadow-md border-2 border-white" />
      ...
      <div class="mb-8">
        ...
        <div v-if="activities.length === 0" class="text-center py-16 bg-white rounded-2xl shadow-lg border border-gray-100">
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div v-for="activity in activities" :key="activity._id" class="group">
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
              <card-activity
                :activity="activity"
